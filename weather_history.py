...
class WeatherHistory:
    ...
    def start_weather_history(self):
        ...
        while True:
            self.do_weather_history_check()
            print "Sleeping till tomorrow"
            time.sleep(86400)

    def do_weather_history_check(self):
        ...
        query = '''INSERT INTO WeatherHistory (timestamp, temp_high, temp_low) VALUES (''' + str(int(time.time()-54000)) + ''',''' + str(contents["daily"]["data"][0]["temperatureHigh"])+ ''',''' +str(contents["daily"]["data"][0]["temperatureLow"])+ ''')'''
